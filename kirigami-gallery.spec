...
Version  : 25.04.1
Release  : 36
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kirigami-gallery-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kirigami-gallery-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kirigami-gallery-25.04.1.tar.xz.sig
...
%setup -q -n kirigami-gallery-25.04.1
cd %{_builddir}/kirigami-gallery-25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747201093
mkdir -p clr-build
pushd clr-build
