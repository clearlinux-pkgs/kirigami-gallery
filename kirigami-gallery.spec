...
Version  : 24.12.3
Release  : 34
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kirigami-gallery-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kirigami-gallery-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kirigami-gallery-24.12.3.tar.xz.sig
...
%setup -q -n kirigami-gallery-24.12.3
cd %{_builddir}/kirigami-gallery-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742534732
mkdir -p clr-build
pushd clr-build
