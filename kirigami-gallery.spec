...
Version  : 24.08.2
Release  : 29
URL      : https://download.kde.org/stable/release-service/24.08.2/src/kirigami-gallery-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/kirigami-gallery-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/kirigami-gallery-24.08.2.tar.xz.sig
...
%setup -q -n kirigami-gallery-24.08.2
cd %{_builddir}/kirigami-gallery-24.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728778073
mkdir -p clr-build
pushd clr-build
