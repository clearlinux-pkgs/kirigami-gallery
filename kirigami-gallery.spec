...
Version  : 24.12.1
Release  : 32
URL      : https://download.kde.org/stable/release-service/24.12.1/src/kirigami-gallery-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kirigami-gallery-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kirigami-gallery-24.12.1.tar.xz.sig
...
%setup -q -n kirigami-gallery-24.12.1
cd %{_builddir}/kirigami-gallery-24.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736574275
mkdir -p clr-build
pushd clr-build
