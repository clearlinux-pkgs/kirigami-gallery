...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kirigami-gallery-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kirigami-gallery-24.08.0.tar.xz.sig
...
%setup -q -n kirigami-gallery-24.08.0
cd %{_builddir}/kirigami-gallery-24.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724663485
mkdir -p clr-build
pushd clr-build
